...
! Added for Flare triggering simulations

  REAL(num), DIMENSION(:,:,:), ALLOCATABLE :: ctv1, ctx1, cty1, ctz1
  REAL(num), DIMENSION(:,:,:), ALLOCATABLE :: ellv1, ellx1, elly1, ellz1
  REAL(num), DIMENSION(:,:,:), ALLOCATABLE :: ctv2, ctx2, cty2, ctz2
  REAL(num), DIMENSION(:,:,:), ALLOCATABLE :: ellv2, ellx2, elly2, ellz2
  REAL(num) :: rotamp, phic1, phic2, disp1, disp2
  REAL(num) :: xx1, xx2, yy1, yy2, zz, cr1, cr2, cz1, cz2

! Flare triggering parameters

  REAL(num) :: theta0 = 80.0_num
  REAL(num) :: phif = 180.0_num
  REAL(num) :: vzf = 0.01_num
  REAL(num) :: z0 =-0.2_num
  REAL(num) :: r0 = 0.2_num
  REAL(num) :: a0 = 0.2_num
