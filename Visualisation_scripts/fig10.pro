...
; IDL script used to produce Fig10 in 
...
; To produce Fig10 this script was used on the output from a simulation
; with two colliding injected fields

; Cycle through the relevant outputs
for i = 0,12,3 do begin
...
filename = 'coll1'+String(i, Format='(I3.3)')+'.png'
c0.save, filename
...
; Save image to file
filename = 'coll2'+String(i, Format='(I3.3)')+'.png'
c1.save, filename
